...
import (
	...
	"github.com/ws4charlie/eth-cc/crypto/signify"
	"github.com/ws4charlie/eth-cc/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/ws4charlie/eth-cc/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/ws4charlie/eth-cc/internal/version.gitDate="+env.Date)
	}
